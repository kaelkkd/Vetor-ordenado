...
O arquivo main contem um exemplo de uma funcao de comparacao
o usuario pode alterar de maneira que melhor o sirva
*/
...
typedef struct vet{
	...
	int numElems;//numero de elementos no vetor  
...
@param vetTam: o tamanho do vetor
